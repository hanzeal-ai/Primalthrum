...
export type ErrorCode =
  ...
  | 'WORKSPACE_NOT_FOUND'
  | 'WORKSPACE_OWNERSHIP_CURRENT_OWNER_REQUIRED'
  | 'WORKSPACE_OWNERSHIP_TARGET_MEMBER_NOT_FOUND'
  | 'WORKSPACE_OWNERSHIP_TARGET_MEMBER_INVALID'
  | 'WORKSPACE_OWNERSHIP_TARGET_CONFIRMATION_MISMATCH'
  | 'WORKSPACE_OWNERSHIP_TRANSFER_CONFLICT'
  | 'WORKSPACE_OWNERSHIP_TRANSFER_FAILED';
