import { BarChart3, CreditCard, LogOut, MessageSquare, Sparkles } from 'lucide-react'
...
export type WorkspaceAppSection = 'builder' | 'usage' | 'billing'
...
function navigationAllowed(section: WorkspaceAppSection, user: AuthUser): boolean {
  return section === 'builder' || canReadBilling(user.role)
}
