...
(
  ...
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresConnectionPoolSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
  ...
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresWorkerRollingHandoffSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
  ...
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresMfaAppSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresWorkspaceOwnershipAppSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresAbuseProtectionAppSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresPrivacyAnalyticsAppSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresRetentionAppSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresAccountPrivacyAppSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresWorkspaceLegalHoldRepositorySmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresOperatorIdentityAuditRepositorySmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresSupportAccessRepositorySmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresOperatorDomainReadRepositoriesSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresOperatorOverviewBillingReadSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresOperatorFeatureFlagRepositorySmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
    pnpm exec ts-node src/commands/postgresOperatorAppSmoke.ts
  DATABASE_URL="postgresql://postgres:${PASSWORD}@127.0.0.1:${PORT}/${DATABASE}" \
